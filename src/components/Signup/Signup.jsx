        ...
        <div className="container w-[100vw] overflow-hidden">
            ...
            <div className='flex justify-center w-[100vw] h-[100vh] items-center'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <input type="text" name="" placeholder='Email Id' id="" className='p-5 m-5 h-[10px] w-[25rem] border-[#00FFDD] placeholder-white bg-[transparent] border-2 rounded-[15px] hover:p-6 duration-[0.4s] hover:rounded-[25px]'/>
                    ...
                    <button className='text-[1.5rem] text-[#00FFDD] bg-black p-3 w-[15rem]'>Resister</button>
                </div>
            </div>
        </div>
    )
